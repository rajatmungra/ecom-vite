  ...
  return (
    ...
    >
      <ul className='nav nav-pills mb-3' id='pills-tab' role='tablist'>
        <li
          onClick={() => dispatch(product_order('default'))}
          className='nav-item'
        >
          <a
        ...
        <li
          onClick={() => dispatch(product_order('decreasing'))}
          className='nav-item'
        >
          <a
            className='nav-link'
        ...
        <li
          onClick={() => dispatch(product_order('increasing'))}
          className='nav-item'
        >
          <a
            className='nav-link'
